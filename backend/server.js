...
app.get('/api/summary/:id', (req, res) => {
  ...
  getDetails(id).then((result) => {
    ...
    // var raw = `{"contents":[{"parts":{"text":${process.env.SUMMARY_PRETEXT} ${JSON.stringify(result)}]}]}`;
